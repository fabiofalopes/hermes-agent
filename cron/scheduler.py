...
def _run_job_script_with_claim_heartbeat(
    job: dict, script_path: str, script_args: str = "",
    workdir: Optional[str] = None,
) -> tuple[bool, str]:
    ...
    if not (
        ...
        return _run_job_script(script_path, script_args, workdir=workdir)
...
def run_job(
    ...
    if job.get("no_agent"):
        ...
        try:
            ok, output = _run_job_script_with_claim_heartbeat(
                job, script_path, job.get("script_args", ""),
    ...
    script_args = job.get("script_args", "")
    if script_path:
        prerun_script = _run_job_script_with_claim_heartbeat(job, script_path, script_args)
