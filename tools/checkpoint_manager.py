...
DEFAULT_EXCLUDES = [
    ...
    # SSH (2026-06-01: never checkpoint SSH state — caused silent config rewrite bug,
    # see vault Infrastructure/SSH-Incident-2026-06-01)
    ".ssh/", ".ssh/**", "authorized_keys", "id_rsa", "id_ed25519", "id_ecdsa", "*.pem",
