...
_DEFAULT_PROVIDER_MODELS = {
    ...
    "opencode-zen": ["big-pickle", "claude-sonnet-5", "deepseek-v4-flash", "deepseek-v4-flash-free", "deepseek-v4-pro", "glm-5.2", "grok-build-0.1", "hy3-free", "kimi-k2.7-code", "mimo-v2.5-free", "minimax-m2.7", "minimax-m3", "nemotron-3-ultra-free", "north-mini-code-free"],
