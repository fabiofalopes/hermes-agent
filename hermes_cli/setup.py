...
_DEFAULT_PROVIDER_MODELS = {
    ...
    "opencode-zen": ["big-pickle", "claude-fable-5-1", "claude-opus-5", "claude-sonnet-5", "deepseek-v4-flash", "deepseek-v4-flash-free", "deepseek-v4-pro", "gemini-3.5-flash-lite", "gemini-3.6-flash", "gemini-3.7-flash", "glm-5.2", "gpt-5.6-luna", "gpt-5.6-sol", "gpt-5.6-terra", "grok-4.5", "grok-4.6", "grok-build-0.1", "kimi-k2.7-code", "kimi-k3", "laguna-s-2.1-free", "ling-3.0-flash-fin-free", "mimo-v2.5-free", "minimax-m2.7", "minimax-m3", "muse-spark-1.2", "muse-spark-1.2-contributor-free", "nemotron-3-ultra-free", "nemotron-3.5-lightning-free"],
