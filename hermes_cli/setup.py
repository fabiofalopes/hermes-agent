...
_DEFAULT_PROVIDER_MODELS = {
    ...
    "opencode-zen": ["big-pickle", "deepseek-v4-flash", "deepseek-v4-flash-free", "deepseek-v4-pro", "glm-5.2", "grok-build-0.1", "mimo-v2.5-free", "minimax-m2.7", "minimax-m3-free", "nemotron-3-ultra-free", "north-mini-code-free", "qwen3.6-plus-free"],
