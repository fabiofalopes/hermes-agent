...
# Some providers (e.g. modelos.ai.ulusofona.pt behind LiteLLM) return reasoning
# embedded in TEXT content as <think>...</think> rather than as structured
# thinking blocks. Extract them so they do not leak into visible output.
_THINK_RE = re.compile(r'<think>(.*?)</think>', re.DOTALL)


def _split_embedded_thinking(text: str):
